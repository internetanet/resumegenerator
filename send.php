...
///////////////////////////////Класс для отправки смс-сообщений (восстановление пароля)
class QTSMS {
	var $user = '40893';			// ваш логин в системе 
	var $pass = '97255493';			// ваш пароль в системе
	var $hostname='go.qtelecom.ru/public/http/';   // адрес сервера отправки сообщений (без http)
...
if(!function_exists('http_build_query')) {
 ...
 // Отправка SMS сообщения по списку адресатов
    ...
    $sender = 'vdnh';
    $period = 120;
    $sms= new QTSMS('userX.Y','пароль','go.qtelecom.ru');
    $sms= new QTSMS('40893','97255493','go.qtelecom.ru/public/http/');
